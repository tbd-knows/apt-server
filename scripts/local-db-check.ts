...
async function resetDatabase() {
  ...
  assert.equal(files.length, 13, 'Expected six historical migrations plus pilot, A2A, research, inspection, connection, service action and connected return refund migrations.');
